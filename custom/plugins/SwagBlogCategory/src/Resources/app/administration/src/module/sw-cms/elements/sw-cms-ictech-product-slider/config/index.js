import template from './sw-cms-el-config-ictech-product-slider.html.twig';
import './sw-cms-el-config-ictech-product-slider.scss';
...
Component.register('sw-cms-el-config-ictech-product-slider', {
    template,
