...
namespace SwagBlogCategory\Core\Content\ictechVideoImageTaxes\cms;
...
#[Package('content')]
class IctechVideoImageTextCmsElementResolver extends AbstractCmsElementResolver
{
    ...
    {
        return 'ictech-video-image-text';
    }
